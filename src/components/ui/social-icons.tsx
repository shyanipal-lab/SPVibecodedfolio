...
const defaultSocials: SocialItem[] = [
  ...
  {
    name: "GitHub",
    href: "https://github.com/shyanipal",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
  ...
  {
    name: "Dribbble",
    href: "https://dribbble.com/shyanipal",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
...
export function SocialIcons({ 
  ...
  return (
    <div className={`relative flex items-center gap-0.5 px-1.5 py-1.5 rounded-2xl bg-neutral-950 border border-white/[0.08] ${className || ""}`}>
      ...
      {socials.map((social, index) => (
        ...
        >
          ...
          <span
            className={`absolute -top-10 left-1/2 -translate-x-1/2 px-2.5 py-1 rounded-lg bg-white text-neutral-950 text-[11px] font-medium whitespace-nowrap transition-all duration-300 ease-out z-30 ${
